    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('callback', models.ForeignKey(verbose_name='Callback', to='django_workflow.Callback', on_delete=PROTECT)),
            ],
        ),
        migrations.CreateModel(
            name='Condition',
            fields=[
                ...
                ('parent_condition', models.ForeignKey(related_name='child_conditions', verbose_name='Parent Condition', blank=True, to='django_workflow.Condition', null=True, on_delete=PROTECT)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('function_module', models.CharField(max_length=400, verbose_name='Module')),
                ('condition', models.ForeignKey(verbose_name='Condition', to='django_workflow.Condition', on_delete=PROTECT)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, verbose_name='Name')),
                ('value', models.CharField(max_length=4000, verbose_name='Value')),
                ('function', models.ForeignKey(related_name='parameters', verbose_name='Function', to='django_workflow.Function', on_delete=PROTECT)),
            ],
        ),
        migrations.CreateModel(
            name='State',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_state', models.ForeignKey(related_name='incoming_transitions', verbose_name='Final State', to='django_workflow.State', on_delete=PROTECT)),
                ('initial_state', models.ForeignKey(related_name='outgoing_transitions', verbose_name='Initial State', to='django_workflow.State', on_delete=PROTECT)),
            ],
            options={
                'ordering': ['priority'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transition', models.ForeignKey(verbose_name='Transition', to='django_workflow.Transition', on_delete=PROTECT)),
            ],
        ),
        migrations.CreateModel(
            name='Workflow',
        ...
        migrations.AddField(
            ...
            name='workflow',
            field=models.ForeignKey(editable=False, to='django_workflow.Workflow', verbose_name='Workflow', on_delete=PROTECT),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='state',
            name='workflow',
            field=models.ForeignKey(verbose_name='Workflow', to='django_workflow.Workflow', on_delete=PROTECT),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='state',
            field=models.ForeignKey(verbose_name='State', to='django_workflow.State', on_delete=PROTECT),
        ),
        migrations.AddField(
            model_name='currentobjectstate',
            name='workflow',
        ...
        migrations.AddField(
            ...
            name='transition',
            field=models.ForeignKey(verbose_name='Transition', blank=True, to='django_workflow.Transition', null=True, on_delete=PROTECT),
        ),
        migrations.AddField(
            model_name='condition',
            name='workflow',
        ...
        migrations.AddField(
            model_name='callback',
            name='transition',
            field=models.ForeignKey(verbose_name='Transition', to='django_workflow.Transition', on_delete=PROTECT),
        ),
        migrations.AddField(
            model_name='callback',
            name='workflow',
